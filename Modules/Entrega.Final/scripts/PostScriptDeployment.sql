...
IF OBJECT_ID('[Entrega.Final].[dbo].[Registros]', 'U') IS NOT NULL
BEGIN
    ALTER TABLE [Entrega.Final].[dbo].[Registros] DROP CONSTRAINT IF EXISTS [FK_Registos_Empresas];
    ALTER TABLE [Entrega.Final].[dbo].[Registros] DROP CONSTRAINT IF EXISTS [FK_Registos_Ciudades];
    ALTER TABLE [Entrega.Final].[dbo].[Registros] DROP CONSTRAINT IF EXISTS [FK_Registos_Departamentos];
    ALTER TABLE [Entrega.Final].[dbo].[Registros] DROP CONSTRAINT IF EXISTS [FK_Registos_PaisesOrigen];
    ALTER TABLE [Entrega.Final].[dbo].[Registros] DROP CONSTRAINT IF EXISTS [FK_Registos_PaisesProcedencia];
    ALTER TABLE [Entrega.Final].[dbo].[Registros] DROP CONSTRAINT IF EXISTS [FK_Registros_DescripcionesComerciales];
    ALTER TABLE [Entrega.Final].[dbo].[Registros] DROP CONSTRAINT IF EXISTS [FK_Registros_Regimenes];
    ALTER TABLE [Entrega.Final].[dbo].[Registros] DROP CONSTRAINT IF EXISTS [FK_Registos_UnidadesFisicas];

    SET IDENTITY_INSERT [Entrega.Final].[dbo].[Registros] OFF;
END;
GO
...
BEGIN
    ...
    ALTER TABLE [Entrega.Final].[dbo].[Registros] ADD CONSTRAINT [FK_Registos_Empresas] FOREIGN KEY ([EmpresaID]) REFERENCES [dbo].[Empresas] ([EmpresaID]);
    ALTER TABLE [Entrega.Final].[dbo].[Registros] ADD CONSTRAINT	[FK_Registos_Ciudades] FOREIGN KEY ([CiudadID]) REFERENCES [dbo].[Ciudades] ([CiudadID]);
	ALTER TABLE [Entrega.Final].[dbo].[Registros] ADD CONSTRAINT	[FK_Registos_Departamentos] FOREIGN KEY ([DepartamentoID]) REFERENCES [dbo].[Departamentos] ([DepartamentoID]);
	ALTER TABLE [Entrega.Final].[dbo].[Registros] ADD CONSTRAINT [FK_Registos_PaisesOrigen] FOREIGN KEY ([PaisOrigenID]) REFERENCES [dbo].[PaisesOrigen] ([PaisOrigenID]);
	ALTER TABLE [Entrega.Final].[dbo].[Registros] ADD CONSTRAINT [FK_Registos_PaisesProcedencia] FOREIGN KEY ([PaisProcedenciaID]) REFERENCES [dbo].[PaisesProcedencia] ([PaisProcedenciaID]);
	ALTER TABLE [Entrega.Final].[dbo].[Registros] ADD CONSTRAINT	[FK_Registros_DescripcionesComerciales] FOREIGN KEY ([DescripcionComercialID]) REFERENCES [dbo].[DescripcionesComerciales] ([DescripcionComercialID]);
	ALTER TABLE [Entrega.Final].[dbo].[Registros] ADD CONSTRAINT [FK_Registros_Regimenes] FOREIGN KEY ([RegimenID]) REFERENCES [dbo].[Regimenes] ([RegimenID]);
	ALTER TABLE [Entrega.Final].[dbo].[Registros] ADD CONSTRAINT [FK_Registos_UnidadesFisicas] FOREIGN KEY ([UnidadFisicaID]) REFERENCES [dbo].[UnidadesFisicas] ([UnidadFisicaID]);

    SET IDENTITY_INSERT [Entrega.Final].[dbo].[Registros] ON;

    MERGE INTO [Entrega.Final].[dbo].[Registros] AS [TARGET]
